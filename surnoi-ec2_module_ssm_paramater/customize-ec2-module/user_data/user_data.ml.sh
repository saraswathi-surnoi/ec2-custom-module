#!/bin/bash
# ==============================================================================
# Script Name   : aiml_env_setup.sh
# Description   : Automated setup script for AIML backend environments.
#                 Installs and configures Python 3.11.9, Redis, Docker,
#                 MySQL client libraries, and essential build tools for
#                 Ubuntu/Debian or Amazon Linux/RHEL/CentOS systems.
# Authors       : Nandula Saraswathi, Kanaparthi Siddharth
# Updated By    : Nandula Saraswathi, Kanaparthi Siddharth
# ==============================================================================
