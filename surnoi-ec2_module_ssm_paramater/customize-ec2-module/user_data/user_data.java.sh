...
#
#  Description:
#    This script automates the setup of a backend environment for Java-based applications.
#    It installs and configures Java 21, Docker, Maven, Git, and AWS CLI v2 on both Ubuntu/Debian
#    and Amazon Linux/RHEL/CentOS systems.
#
#  Usage:
...
#  Company:  Surnoi Technology Pvt Ltd
#  Project:  Logistics MOT Platform
###################################################################################################
